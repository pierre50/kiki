...
import { findInstancesInSight, getInstanceClosestFreeCellPath, getInstancePath, instanceContactInstance, instanceRotate, instancesDistance, moveTowardPoint } from "../libs/utils";
...
export default class Unit {
    constructor(options, context) {
        ...
        this.path = [];
        this.cell = map.grid[Math.round(this.x)][Math.round(this.z)];
        this.cell.has = this;
        ...
        mesh.position.y = this.cell.y + 0.5 / 2;
