 ...
 * @param {number} max 
 */
export function randomRange(min, max, floor = true) {
 ...
 * @param {number} y 
 */
export function getInstanceDegree(x1, z1, x2, z2) {
	const tX = x1 - x2;
	const tZ = z1 - z2;
 ...
 * @param {number} height 
 */
export function pointInRectangle(x, y, left, top, width, height) {
...
export function getZoneInZoneWithCondition(zone, grid, size, condition) {
...
export function getPositionInZoneAroundInstance(instance, grid, space, size, allowInclined = false, extraCondition) {
